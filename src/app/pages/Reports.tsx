  ...
  return (
    <div className="min-h-full bg-stone-50 text-gray-950">
      ...
      {selectedReport && reportData && selectedCard && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 sm:justify-end" onClick={() => setSelectedReport(null)}>
          <div
            className="max-h-[92svh] w-full max-w-4xl overflow-y-auto rounded-t-2xl bg-background shadow-2xl animate-in slide-in-from-bottom-4 duration-300 sm:h-full sm:max-h-none sm:rounded-none sm:slide-in-from-right"
          ...
          >
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm">
                ...
                <div className="h-64 sm:h-80" key={`report-chart-${chartId}`}>
