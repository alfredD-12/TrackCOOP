...
<head>
    ...
    <style>
        ...
        .page-header { background: transparent; padding: 50px 0 0; margin-bottom: 20px; }
        .form-card { background: white; border-radius: 20px; border: 1px solid rgba(226,232,240,0.8); padding: 36px; box-shadow: 0 4px 6px rgba(0,0,0,0.02); }
        ...
        .btn-cancel { background: #f1f5f9; color: #64748b; border-radius: 12px; padding: 14px 28px; font-weight: 600; text-decoration: none; border: none; transition: 0.3s; }
...
<div class="page-header">
    <div class="container">
        <div class="d-flex align-items-center mb-0">
            ...
            <div class="badge bg-white text-emerald border-emerald border rounded-pill px-3 py-1 fw-bold text-uppercase small" style="font-size:0.7rem; border-color: #27ae60 !important; color: #27ae60 !important;">Editing Mode</div>
        </div>
    </div>
</div>
